 ...
 *
 * @param type $classes Add the category class.
 */
 ...
 *
 * @param type $menu Return the menu.
 * @param type $args Return the menu options.
 */
 ...
 *
 * @param type $post_info Return custom post info.
 */
 ...
 *
 * @param type $text Return custom text for search.
 */
